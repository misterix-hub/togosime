                                        ...
                                        @forelse ($categories as $categorie)    
                                            <tr>
                                                ...
                                                <td width="120" class="text-center">
                                                    <a href="{{ route('detailsCategorie', $categorie->id) }}" class="btn btn-outline-success">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="{{ route('supprimerCategorie', $categorie->id) }}" class="btn btn-outline-danger">
