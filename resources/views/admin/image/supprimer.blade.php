        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12"><br /><br />
                    ...
                    Êtes-vous sûr(e) de vouloir supprimer cette image ? Cette action sera irréversible.<br /><br />
                    <a href="{{ route('listeImage') }}" class="btn btn-secondary">
                        Annuler
                    </a>
                    <a href="{{ route('supprimerImageForm', $id) }}" class="btn btn-danger">
                        Supprimer
                    </a>
